            ...
            <div className='my-1'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className={`space-y-1 ${!isEdit&&!isAdd?'hidden':''} `}>
                        ...
                        <input className={`py-1 border rounded w-full placeholder:text-sm px-4 ${errors.height && 'border-red-600'}`} {...register("height")} name='height' placeholder='input height' type="text" />
